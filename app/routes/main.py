...
def build_export_layout():
    ...
    return ExportLayout(
        ...
        definition_header_alignment=values['export_definition_header_alignment'],
        reflect_alignment=values['export_reflect_alignment'],
        reflect_header_alignment=values['export_reflect_header_alignment'],
        ...
        content_role_styles={
            'title': {
                ...
                'margin_above': _export_float_setting(values, 'export_title_margin_above', 0, 2.0) * inch,
                'margin_below': _export_float_setting(values, 'export_title_margin_below', 0, 2.0) * inch,
            ...
            'subtitle': {
                ...
                'margin_above': _export_float_setting(values, 'export_subtitle_margin_above', 0, 2.0) * inch,
                'margin_below': _export_float_setting(values, 'export_subtitle_margin_below', 0, 2.0) * inch,
            ...
            'chapter': {
                ...
                'margin_above': _export_float_setting(values, 'export_content_chapter_margin_above', 0, 2.0) * inch,
                'margin_below': _export_float_setting(values, 'export_content_chapter_margin_below', 0, 2.0) * inch,
            ...
            'header': {
                ...
                'margin_above': _export_float_setting(values, 'export_header_margin_above', 0, 2.0) * inch,
                'margin_below': _export_float_setting(values, 'export_header_margin_below', 0, 2.0) * inch,
        ...
        definition_header_font_size=_export_float_setting(values, 'export_definition_header_font_size', 5, 16),
        reflect_font_size=_export_float_setting(values, 'export_reflect_font_size', 5, 16),
        reflect_header_font_size=_export_float_setting(values, 'export_reflect_header_font_size', 5, 16),
        ...
        inline_marker_font_size=_export_float_setting(values, 'export_inline_marker_font_size', 4, 14),
        footnote_marker_font_size=_export_float_setting(values, 'export_footnote_marker_font_size', 4, 14),
        ...
        definition_header_line_spacing=_export_float_setting(values, 'export_definition_header_line_spacing', 0.8, 2.0),
        reflect_line_spacing=_export_float_setting(values, 'export_reflect_line_spacing', 0.8, 2.0),
        reflect_header_line_spacing=_export_float_setting(values, 'export_reflect_header_line_spacing', 0.8, 2.0),
        ...
        definition_header_kerning=_export_float_setting(values, 'export_definition_header_kerning', -1.0, 2.0),
        reflect_kerning=_export_float_setting(values, 'export_reflect_kerning', -1.0, 2.0),
        reflect_header_kerning=_export_float_setting(values, 'export_reflect_header_kerning', -1.0, 2.0),
        ...
        inline_marker_kerning=_export_float_setting(values, 'export_inline_marker_kerning', -1.0, 2.0),
        footnote_marker_kerning=_export_float_setting(values, 'export_footnote_marker_kerning', -1.0, 2.0),
        ...
        definition_header_font=_export_font_setting(values, 'export_definition_header_font'),
        reflect_font=_export_font_setting(values, 'export_reflect_font'),
        reflect_header_font=_export_font_setting(values, 'export_reflect_header_font'),
        ...
        inline_marker_font=_export_font_setting(values, 'export_inline_marker_font'),
        footnote_marker_font=_export_font_setting(values, 'export_footnote_marker_font'),
        ...
        definition_header_gray=_export_float_setting(values, 'export_definition_header_gray', 0, 90),
        reflect_gray=_export_float_setting(values, 'export_reflect_gray', 0, 90),
        reflect_header_gray=_export_float_setting(values, 'export_reflect_header_gray', 0, 90),
        ...
        inline_marker_gray=_export_float_setting(values, 'export_inline_marker_gray', 0, 90),
        footnote_marker_gray=_export_float_setting(values, 'export_footnote_marker_gray', 0, 90),
        inline_marker_raise=_export_float_setting(values, 'export_inline_marker_raise', -2, 10),
        footnote_marker_raise=_export_float_setting(values, 'export_footnote_marker_raise', -2, 10),
        inline_marker_bold=_export_bool_setting(values, 'export_inline_marker_bold'),
        inline_marker_italic=_export_bool_setting(values, 'export_inline_marker_italic'),
        footnote_marker_bold=_export_bool_setting(values, 'export_footnote_marker_bold'),
        footnote_marker_italic=_export_bool_setting(values, 'export_footnote_marker_italic'),
        reflect_margin_above=_export_float_setting(values, 'export_reflect_margin_above', 0, 2.0) * inch,
        reflect_margin_below=_export_float_setting(values, 'export_reflect_margin_below', 0, 2.0) * inch,
        definition_margin_above=_export_float_setting(values, 'export_definition_margin_above', 0, 2.0) * inch,
        definition_margin_below=_export_float_setting(values, 'export_definition_margin_below', 0, 2.0) * inch,
        definition_bold=_export_bool_setting(values, 'export_definition_bold'),
        definition_italic=_export_bool_setting(values, 'export_definition_italic'),
        definition_all_caps=_export_bool_setting(values, 'export_definition_all_caps'),
        definition_header_bold=_export_bool_setting(values, 'export_definition_header_bold'),
        definition_header_italic=_export_bool_setting(values, 'export_definition_header_italic'),
        definition_header_all_caps=_export_bool_setting(values, 'export_definition_header_all_caps'),
        reflect_bold=_export_bool_setting(values, 'export_reflect_bold'),
        reflect_italic=_export_bool_setting(values, 'export_reflect_italic'),
        reflect_all_caps=_export_bool_setting(values, 'export_reflect_all_caps'),
        reflect_header_bold=_export_bool_setting(values, 'export_reflect_header_bold'),
        reflect_header_italic=_export_bool_setting(values, 'export_reflect_header_italic'),
        reflect_header_all_caps=_export_bool_setting(values, 'export_reflect_header_all_caps'),
    )
...
def export_book_pdf(book_id):
    ...
    if not pages:
        abort(404)
    layout = build_export_layout()
    pdf_buffer = build_pages_pdf(book_id, pages, layout=layout, include_topic_index=True)
